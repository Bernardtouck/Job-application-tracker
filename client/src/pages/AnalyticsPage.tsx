...
const COMPANIES = [
  { name: "Google", color: "#4285F4", svg: (<svg viewBox="0 0 24 24" fill="none"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>) },
  { name: "Microsoft", color: "#00A4EF", svg: (<svg viewBox="0 0 24 24" fill="none"><rect x="1" y="1" width="10" height="10" fill="#F25022"/><rect x="13" y="1" width="10" height="10" fill="#7FBA00"/><rect x="1" y="13" width="10" height="10" fill="#00A4EF"/><rect x="13" y="13" width="10" height="10" fill="#FFB900"/></svg>) },
  { name: "Amazon", color: "#FF9900", svg: (<svg viewBox="0 0 24 24" fill="#FF9900"><path d="M13.958 10.09c0 1.232.029 2.256-.591 3.351-.502.891-1.301 1.438-2.186 1.438-1.214 0-1.922-.924-1.922-2.292 0-2.692 2.415-3.182 4.7-3.182v.685zm3.186 7.705c-.209.189-.512.201-.745.075-1.052-.872-1.238-1.276-1.814-2.106-1.734 1.768-2.962 2.297-5.209 2.297-2.66 0-4.731-1.641-4.731-4.925 0-2.565 1.391-4.309 3.37-5.164 1.715-.754 4.11-.891 5.942-1.097v-.41c0-.753.06-1.642-.384-2.294-.385-.579-1.124-.82-1.775-.82-1.205 0-2.277.618-2.54 1.897-.054.285-.261.567-.547.582l-3.065-.333c-.259-.058-.548-.266-.472-.66C6.014 2.088 9.098 1 11.88 1c1.425 0 3.286.379 4.409 1.459 1.425 1.332 1.289 3.112 1.289 5.044v4.568c0 1.373.57 1.975 1.107 2.717.188.264.229.58-.012.777l-1.529 1.23zm3.271 2.818C18.306 22.281 14.993 24 12.077 24c-3.869 0-7.358-1.432-9.996-3.818-.207-.187-.022-.443.226-.298 2.847 1.658 6.366 2.656 10.003 2.656 2.452 0 5.151-.508 7.631-1.564.374-.16.69.247.314.537z"/></svg>) },
  { name: "Meta", color: "#0668E1", svg: (<svg viewBox="0 0 24 24" fill="#0668E1"><path d="M12 2C6.477 2 2 6.477 2 12c0 5.013 3.693 9.153 8.505 9.876V14.65H8.031v-2.629h2.474v-1.749c0-2.896 1.411-4.167 3.818-4.167 1.153 0 1.762.085 2.051.124v2.294h-1.642c-1.022 0-1.379.969-1.379 2.061v1.437h2.995l-.406 2.629h-2.588v7.247C18.235 21.236 22 17.062 22 12c0-5.523-4.477-10-10-10z"/></svg>) },
  ...
  { name: "GitHub", color: "#fff", svg: (<svg viewBox="0 0 24 24" fill="white"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>) },
  { name: "LinkedIn", color: "#0A66C2", svg: (<svg viewBox="0 0 24 24" fill="#0A66C2"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>) },
  { name: "SAP", color: "#009FDB", svg: (<svg viewBox="0 0 24 24" fill="#009FDB"><path d="M0 0v24h24V0zm14.254 5.28l3.324 8.73h-2.41l-.56-1.57h-3.11l-.55 1.57H8.56l3.35-8.73zm-1.62 2.55l-1.02 2.9h2.04zm-7.76-.28c1.25 0 2.26.39 2.91 1.09l-1.37 1.2c-.34-.38-.84-.6-1.48-.6-.97 0-1.61.59-1.61 1.53 0 .94.65 1.53 1.63 1.53.56 0 1.04-.19 1.37-.53v-.5H5.19V9.7h3.17v2.99c-.74.79-1.83 1.26-3.17 1.26C3.1 13.95 1.5 12.6 1.5 10.75c0-1.86 1.6-3.2 3.37-3.2zm13.9 5.47c.53 0 1 .18 1.35.49l-1 1.07c-.1-.11-.21-.17-.34-.17-.26 0-.43.17-.43.43 0 .44.49.67.98 1.05.57.44.98.99.98 1.77 0 1.07-.77 1.8-1.89 1.8-.67 0-1.28-.22-1.71-.62l.96-1.11c.16.16.39.27.64.27.31 0 .52-.18.52-.46 0-.49-.57-.75-1.1-1.16-.51-.39-.86-.91-.86-1.63 0-1.01.72-1.73 1.9-1.73z"/></svg>) },
];
  ...
  return (
    <div className="arc-container">
      ...
      {COMPANIES.map((company, i) => {
        ...
        return (
          <div key={company.name} className="arc-logo"
            style={{ left: `${x}px`, top: `${y}px`, animationDelay: `${i * 0.4}s`, "--logo-color": company.color } as React.CSSProperties}
            title={company.name}>
            {company.svg}
          </div>
        );
...
export default function AnalyticsPage() {
  ...
  const fetchJobs = useCallback(async () => {
    try { setLoading(true); const res = await API.get("/jobs"); setJobs(res.data); }
  ...
  jobs.forEach((j) => {
    const d = new Date(j.appliedAt).getDay();
    dayCount[d === 0 ? 6 : d - 1]++;
  });
  ...
  const lineData = sorted.map((_, i) => {
    ...
    return { i: i + 1, rate: Math.round((slice.filter((j) => j.status !== "APPLIED").length / (i + 1)) * 100) };
  });
  ...
  const tooltipStyle = {
    background: "#1a1610", border: "1px solid rgba(245,166,35,0.2)",
    borderRadius: 8, fontSize: 12, color: "#F2EDE4",
  };
  ...
  return (
    <div className="ap-shell">
      ...
      {/* ── Mobile topbar — visible seulement sur mobile ── */}
      <div className="ap-mobile-topbar">
        <div className="ap-mobile-brand">
          {BriefcaseSVG}
          Job<span>Tracker</span>
        </div>
        <button className="ap-mobile-back" onClick={() => navigate("/dashboard")}>
        ...
        <div className="ap-sidebar-footer">
          <div className="ap-user">
            <div className="ap-avatar">
              {profile?.avatarBase64 ? <img src={profile.avatarBase64} alt="avatar"/> : <span>{profile?.username?.slice(0,2).toUpperCase() ?? "?"}</span>}
            </div>
      ...
      <main className="ap-main">
        <section className="ap-hero">
          <div className="ap-hero-left">
            ...
            <h1 className="ap-hero-title">Analytics<br/><span>Dashboard</span></h1>
            <p className="ap-hero-sub">Track your progress, spot patterns,<br/>and optimize your job search strategy.</p>
        ...
        {loading ? (
          ...
          <div className="ap-charts">
            ...
            <div className="ap-chart-card ap-chart-card--lg">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <LineChart data={lineData} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="rgba(245,166,35,0.06)" vertical={false}/>
                  <XAxis dataKey="i" tick={{ fill: "#4A4236", fontSize: 11 }} axisLine={false} tickLine={false}/>
            ...
            <div className="ap-chart-card ap-chart-card--sm">
                  ...
                  return (
                    <div key={day} className="ap-heatmap-row">
                      ...
                      <div className="ap-heatmap-bar-wrap">
                        <div className="ap-heatmap-bar" style={{ width: `${intensity * 100}%`, opacity: 0.3 + intensity * 0.7 }}/>
                      </div>
              ...
              <p className="ap-heatmap-hint">Best day: <strong>{DAYS[dayCount.indexOf(Math.max(...dayCount))]}</strong></p>
            </div>
          </div>
        )}
      </main>
