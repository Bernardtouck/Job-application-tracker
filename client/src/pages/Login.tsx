...
export default function Login() {
  ...
  const handleLogin = async (e: React.SyntheticEvent) => {
    ...
    try {
      ...
      // Store profile in localStorage for immediate use in Dashboard
    ...
    <div className="login-shell">
      <div className="login-left">
        ...
        <div className="login-hero">
          <h1 className="hero-title">Track every<br /><em>opportunity.</em></h1>
          <p className="hero-sub">Your job search, organized.<br />From application to offer.</p>
        </div>
        <div className="login-stats">
          <div className="login-stat"><span className="login-stat-val">EN</span><span className="login-stat-lbl">English supported</span></div>
          <div className="login-stat-div" />
          <div className="login-stat"><span className="login-stat-val">DE</span><span className="login-stat-lbl">German supported</span></div>
          <div className="login-stat-div" />
          <div className="login-stat"><span className="login-stat-val">OCR</span><span className="login-stat-lbl">Screenshot parsing</span></div>
        </div>
      </div>
          ...
          <form className="login-form" onSubmit={handleLogin} noValidate>
            ...
            <div className="form-group">
              ...
              <div className="input-wrap">
                ...
                <input id="password" type={showPass ? "text" : "password"} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" disabled={loading} />
